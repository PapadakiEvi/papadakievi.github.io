...
::: {.column width="28%"}
![Retrieved from [Cartoonstock](https://www.cartoonstock.com/cartoonview.asp?catref=NL700064)](bemom.jpg){fig-alt="A surprised teacher watching a young student writing on the board 2+2=3.99999."}
:::
::: {.column width="2%"}
